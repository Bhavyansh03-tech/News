...
class SportsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        //  RecyclerView :->
        binding.sportsRyc.layoutManager = LinearLayoutManager(requireContext())
        binding.sportsRyc.setHasFixedSize(true)
    ...
    private fun getNews(){
        RetrofitInstance.apiInterface.getData("in", "sports",1, "dda699352c8648c0a75a1b4222db7cae")
            .enqueue(object : retrofit2.Callback<NewsResponse> {
                override fun onResponse(
                    ...
                    if (news != null){
                        ...
                        binding.sportsRyc.adapter = adapter
