...
class Breaking : Fragment() {
    ...
    override fun onCreateView(
        ...
        //  RecyclerView :->
        binding.breakingRyc.layoutManager = LinearLayoutManager(requireContext())
        binding.breakingRyc.setHasFixedSize(true)
    ...
    private fun getNews(){
        RetrofitInstance.apiInterface.getData("in", "business",1, "dda699352c8648c0a75a1b4222db7cae")
            .enqueue(object : retrofit2.Callback<NewsResponse> {
                override fun onResponse(
                    ...
                    if (news != null){
                        ...
                        binding.breakingRyc.adapter = adapter
