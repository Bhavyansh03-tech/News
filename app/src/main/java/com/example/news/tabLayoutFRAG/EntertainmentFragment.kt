...
class EntertainmentFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        //  RecyclerView :->
        binding.entertainmentRyc.layoutManager = LinearLayoutManager(requireContext())
        binding.entertainmentRyc.setHasFixedSize(true)
    ...
    private fun getNews(){
        RetrofitInstance.apiInterface.getData("in", "entertainment",1, "dda699352c8648c0a75a1b4222db7cae")
            .enqueue(object : retrofit2.Callback<NewsResponse> {
                override fun onResponse(
                    ...
                    if (news != null){
                        ...
                        binding.entertainmentRyc.adapter = adapter
